...
<div class = "container d-flex flex-column align-items-center justify-content-center" style="margin-bottom: 150px;">
            ...
            if($form["state"] == 1){
                ...
                for($i = 0; $i < count($data); $i++){
                    switch ($data[$i]->getSubjectUUID()){
                        case "one":
                            echo '<div class="mb-4">
                                             <label for="exampleInputEmail1" class="form-label m-0">'.$data[$i]->getSubjectName().'</label>
                        ...
                        case "four":
                            echo '<div class="mb-4">
                                             <label for="exampleInputEmail1" class="form-label m-0">'.$data[$i]->getSubjectName().'</label>
                                             <textarea style="resize: none;" placeholder="Вводите любой текст" type="text" class="form-control" minlength="1" maxlength="255" id="exampleInputEmail1" aria-describedby="emailHelp" name = "input'.$i.'" required></textarea>
                                         </div>';
                            break;
                        case "five":
                            echo '<div class="mb-4">
