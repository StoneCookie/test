...
<?php if(!isset($_GET["id"]) || $_GET["id"] == "") header("Location: /session/index.php"); ?>
<?php session_start(); ?>
...
<body>
    ...
    <?php
        for($b = 0; $b < count($urls); $b++){
            ...
            echo '<h6 class = "text-dark mt-3"><b style="margin: 0 5px 0 10px">ID ссылки:</b><a href="/exam/?url='.$urls[$b].'">'.$urls[$b].'</a></h6>';
            echo '<table class="table table-bordered alert alert-info">
        <thead>
        <tr>
            <th scope="col">#</th>
            <th scope="col">Эксперт</th>';
    ...
    <?php
        ...
        if(count($all_marks) > 0){
            echo '<div class = "mt-5 alert alert-info">';
    ...
    ?>
    <div class = "container mt-5 d-flex flex-column align-items-center justify-content-center" style="margin-bottom: 150px">
    <?php
